# CardView for DataTables with styling for [Bootstrap4](https://getbootstrap.com/docs/4.6/getting-started/introduction/)

This is the distribution package for the [CardView extension](https://datatables.net/extensions/cardview) for [DataTables](https://datatables.net/) with styling for [Bootstrap4](https://getbootstrap.com/docs/4.6/getting-started/introduction/).
...
npm install datatables.net-cardview-bs4
```
...
import 'datatables.net-cardview-bs4'
